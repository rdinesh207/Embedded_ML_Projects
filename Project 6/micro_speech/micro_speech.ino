...
void setup() {
  ...
  static tflite::MicroMutableOpResolver<7> micro_op_resolver;// based on labels adjusted resolver
  if (micro_op_resolver.AddConv2D() != kTfLiteOk) { return; }// added layer check due to version change
